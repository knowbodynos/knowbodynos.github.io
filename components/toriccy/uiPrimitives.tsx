...
export function Card({
  ...
  return (
    <div
      className={cx(
        'rounded-2xl border border-gray-200 bg-white p-3 shadow-md',
        'dark:border-gray-800 dark:bg-gray-950 dark:shadow-lg',
        className
      )}
    >
...
export function FieldLabel({ children }: { children: React.ReactNode }) {
  return (
    <div className="mb-1 text-xs font-semibold text-gray-700 dark:text-gray-300">{children}</div>
  )
}
...
>(function Select({ className, ...props }, ref) {
  return (
    <select
      ...
      {...props}
      className={cx(
        'w-full rounded-xl border px-3 py-1.5 text-sm',
